...
void draw()
{
    ...
    SDL_SetRenderDrawColor(gRenderer,255,0,255,255); //top line
    SDL_RenderDrawLine(gRenderer,160,120,480,120);

    SDL_SetRenderDrawColor(gRenderer,255,255,0,255); //right line
    SDL_RenderDrawLine(gRenderer,480,120,480,360);

    SDL_SetRenderDrawColor(gRenderer,0,255,255,255); //bottom line
    SDL_RenderDrawLine(gRenderer,160,360,480,360);

    SDL_SetRenderDrawColor(gRenderer,0,0,0,255); //left line
